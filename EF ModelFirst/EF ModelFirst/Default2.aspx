<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EF_ModelFirst.Default" %>
...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default2.aspx.cs" Inherits="EF_ModelFirst.Default" %>
...
<body>
  <form id="form2" runat="server">
    <asp:ListView ID="ListView1" runat="server" ItemType="EF_ModelFirst.Customer"
